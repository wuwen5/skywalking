...
public class LogQueryEs7DAO extends LogQueryEsDAO implements ILogQueryDAO {

    public LogQueryEs7DAO(ElasticSearchClient client) {
        super(client, false);
    }

    public LogQueryEs7DAO(ElasticSearchClient client, boolean supportLogRecordContentUseJsonStorage) {
        super(client, supportLogRecordContentUseJsonStorage);
    }
